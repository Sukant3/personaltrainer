...
class _WorkoutScreenState extends State<WorkoutScreen> {
      ...
      _filteredExercises = _exercises.where((exercise) {
        return exercise.name.toLowerCase().contains(query) ||
            exercise.muscleGroup
                .any((group) => group.toLowerCase().contains(query)) ||
  ...
  List<Exercise> getExercisesForCategory(String category) {
    final List<Exercise> pushExercises = [
      Exercise(
        id: '101',
    ...
    final List<Exercise> pullExercises = [
      Exercise(
        id: '201',
    ...
    // final List<Exercise> fullBodyExercises = [
    //   Exercise(name: 'Burpees', id: 'full1'),
    //   Exercise(name: 'Deadlifts', id: 'full2'),
    // ];
    switch (category) {
      case 'Push':
      ...
      case 'FullBody':
        return [
          // Pull: 1st and 2nd (top 2) exercise → indexes [0] and [1]
          ...pushExercises.take(2),

          // Pull: 1st and 4th exercise → indexes [0] and [3]
          pullExercises[0],
          pullExercises[3],

          // Legs: 1st and 3rd exercise → indexes [0] and [2]
          legExercises[0],
          legExercises[2],
        ];
      case 'Mix':
