...
class WorkoutCategoryScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> categories = const [
    ...
    {"name": "FullBody", "icon": Icons.accessibility_new_rounded, "color": Colors.purpleAccent},
    {"name": "Mix", "icon": Icons.auto_graph_rounded, "color": Colors.orangeAccent},
  ];
...
//   final List<Map<String, dynamic>> categories = const [
//     {"name": "Full Body Workout", "icon": Icons.accessibility_new_rounded, "color": Colors.purpleAccent},
//     {"name": "Push Workout", "icon": Icons.fitness_center, "color": Colors.redAccent},
//     {"name": "Pull Workout", "icon": Icons.back_hand, "color": Colors.blueAccent},
//     {"name": "Legs Workout", "icon": Icons.directions_run, "color": Colors.green},
//     {"name": "Mix Workouts", "icon": Icons.auto_graph_rounded, "color": Colors.orangeAccent},
//   ];
