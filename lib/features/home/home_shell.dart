...
import 'package:personaltrainer/features/workout/screens/workout_category_screen.dart';
import 'package:personaltrainer/features/settings/screens/settings_screen.dart';
...
class _HomeShellState extends State<HomeShell> {
  ...
  final _pages = const [
    HomeScreen(),
    WorkoutCategoryScreen(), // 👈 opens the "Push / Pull / Legs" selector first
    GoalsScreen(),
    SettingsScreen(),
  ];
